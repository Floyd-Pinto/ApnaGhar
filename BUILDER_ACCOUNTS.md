...
- **Total Builders:** 10
- **Total Projects:** 75
- **Average Projects per Builder:** 7.5
- **Cities Covered:** Mumbai, Pune, Bangalore, Delhi, Hyderabad

---

## Login Pattern

All builder accounts follow a consistent pattern:

- **Username Format:** `{company}.builder` (lowercase, spaces replaced with dots)
- **Password Format:** `{Company}@123` (first letter capitalized, rest lowercase)
- **Email Format:** `{username}@apnaghar.com`
...
3. Enter the username and password from the table above
4. Access the builder dashboard to view and manage projects

---

## Important Notes

- All accounts have been created with verified status
- Each builder has a trust score of 4.5
- All passwords are properly hashed in the database
- Projects are distributed across multiple cities and localities
- Each builder account can manage construction milestones, upload progress media, and track project status

---

## Management Commands

### Reset Builder Passwords
```bash
python manage.py fix_builder_passwords
```

### Redistribute Projects
```bash
python manage.py redistribute_projects
```

### Add More Projects
```bash
python manage.py add_more_projects
```

---

**Last Updated:** November 9, 2025
**Created By:** ApnaGhar Development Team
